            ...
            <div class="card mb-4">
                <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-9">
                                <input disabled type="text" class="form-control" value="{{$member->tgl_lahir}}" name="tgl_lahir">
                            </div>
                        </div>
                        <hr>
                        <div class="row">
                            ...
                            <div class="col-sm-9">
                                <input disabled type="text" class="form-control text-capitalize" value="{{$member->jabatan}}" name="alamat">
                            </div>
                        </div>
                        <hr>
                        <div class="row">
                            ...
                            <div class="col-sm-9">
                                <input disabled type="text" class="form-control text-capitalize" value="{{$member->divisi->nama_divisi}}" name="alamat"
                                    placeholder="Indonesia">
                            </div>
                        </div>
                </div>
