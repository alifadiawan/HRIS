            ...
            <div class="card mb-4">
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-9">
                            <select class="form-control form-select" name="divisi_id">
                                ...
                                @foreach ($divisi as $d)
                                    <option value="{{ $d->id }}" @if ($member->divisi_id == $d->id) selected @endif>
                    ...
                    <div class="d-flex flex-row mt-3 gap-3">
                        <button class="btn w-50 btn-primary" type="submit">Save</button>
                        <a href="{{ route('employee.index') }}" class="btn btn-outline-secondary w-50">Cancel</a>
                    </div>
                </div>
            </div>
        </form>
