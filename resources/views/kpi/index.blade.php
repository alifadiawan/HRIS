...
@section('content')
    ...
    <div class="container">
        ...
        @foreach ($divisi as $dm)
            <div class="modal fade" id="editDivisi_{{ $dm->id }}" data-bs-backdrop="static" data-bs-keyboard="false"
        ...
        @foreach ($jabatan as $jm)
            <div class="modal fade" id="editJabatan_{{ $jm->id }}" data-bs-backdrop="static"
